    ...
    <footer className="bg-gradient-to-br from-sage via-sage-light to-forest border-t border-gold-accent/40 shadow-elegant">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-deep-forest mb-4 text-lg border-b border-gold-accent/30 pb-2">
              Quick Links
            </h4>
        ...
        <div className="border-t border-gold-accent/40 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link
              to="/"
              className="text-white hover:text-white text-sm transition-colors duration-300 hover:underline decoration-white/60"
            >
              Privacy Policy
            </Link>
            <Link
