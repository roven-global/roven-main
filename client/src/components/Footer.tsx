      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2">
            <Link
              to="/"
              className="font-sans text-2xl sm:text-3xl font-bold text-deep-forest mb-4 block hover:text-white transition-all duration-500 transform hover:scale-105"
            >
              Roven
            </Link>
            <p className="text-deep-forest mb-6 max-w-md leading-relaxed text-xs sm:text-sm md:text-base">
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs sm:text-sm md:text-base">
              <li>
                <Link
                  to="/shop"
                  className="text-deep-forest hover:text-white transition-all duration-300 hover:pl-2 block border-l-2 border-transparent hover:border-white/60 pl-2"
                >
                  Shop All
                </Link>
              </li>
        ...
        {/* Bottom Section */}
        <div className="border-t border-gold-accent/40 pt-8 flex flex-row justify-between items-center">
