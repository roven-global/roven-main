...
interface Customer {
  ...
  lastOrderStatus?: 'pending' | 'processing' | 'shipped' | 'delivered' | 'cancelled';
  orders: Order[];
}
...
const CustomerRow = ({ customer }: { customer: Customer }) => {
  ...
  return (
    <Collapsible asChild key={customer._id} open={isOpen} onOpenChange={setIsOpen}>
      <>
        <TableRow className="cursor-pointer">
          ...
          <TableCell>{customer.email || customer.mobile}</TableCell>
...
const AdminCustomers = () => {
  ...
  const limit = useMemo(() => parseInt(searchParams.get('limit') || '10', 10), [searchParams]);
  const sortBy = useMemo(() => searchParams.get('sortBy') || 'lastOrderDate', [searchParams]);
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-sans font-bold text-foreground mb-6">Customers</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex gap-4">
          <Select onValueChange={handleStatusChange} defaultValue={status || 'all'}>
          ...
          <Select onValueChange={handleSortChange} defaultValue={`${sortBy}:${sortOrder}`}>
            ...
            <SelectContent>
              ...
              <SelectItem value="totalOrders:desc">Total Orders: High to Low</SelectItem>
              <SelectItem value="totalOrders:asc">Total Orders: Low to High</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
