...
const Returns = () => {
  return (
    <div className="max-w-2xl mx-auto py-8 sm:py-12 px-4">
      <h1 className="font-sans text-2xl sm:text-3xl font-bold mb-4 text-foreground">
        Returns & Exchanges
      </h1>
      <p className="mb-4 text-sm sm:text-base text-muted-foreground">
        We want you to love your purchase! If you're not satisfied, here's how
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        ...
        <li>
          ...
          <a
            href="mailto:support@devthreads.com"
            className="text-primary underline"
          >
            support@devthreads.com
          </a>{" "}
      ...
      <p className="mt-6 text-muted-foreground">
        ...
        <a href="/contactus" className="text-primary underline">
          contact us
        </a>
        .
      </p>
