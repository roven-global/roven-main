...
const defaultGifts = [
  ...
  {
    title: "₹200 Off",
    description: "Flat ₹200 discount on orders above ₹1500",
    icon: "DollarSign",
    color: "text-purple-600",
    bgColor: "bg-purple-50 hover:bg-purple-100",
    reward: "Use code: FLAT200",
    couponCode: "FLAT200",
  ...
  {
    title: "Buy 1 Get 1",
    description: "Buy one product, get one free on selected items",
    icon: "Gift",
  ...
  {
    title: "Early Access",
    description: "Early access to new product launches and exclusive deals",
    icon: "Clock",
